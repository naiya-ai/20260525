...
ROOT="${ROOT:-model_experiment/classification_ddp_no_bn_lr3e-5}"
...
NPROC="${NPROC:-8}"
WIDTHS=(${WIDTHS:-32 64 128 256 512 1024 2048 4096 8192 16384 32768 65536})
STEPS="${STEPS:-10000}"
...
for width in "${WIDTHS[@]}"; do
  ...
  echo "==> train width=${width} DDP GPUs=${GPUS} per_gpu_batch=${PER_GPU_BATCH_SIZE} lr=${LR} normalization=${NORMALIZATION}"

...
CONFIG="${CONFIG:-configs/train/train_conditional_vae_mlp_source_z16_beta010_16x.yaml}"
...
SWEEP_ID="${SWEEP_ID:-cvae_mlp_source_z16_beta010_16x_6diseases_knhanes1998_2024_3x_$(date +%Y%m%d_%H%M%S)}"

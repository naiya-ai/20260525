...
CONFIG="${CONFIG:-configs/train/train_conditional_vae_eddi_z128_beta010.yaml}"
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/cvae_z128_beta010_all_disease_indicators/${DATASET_NAME}}"
DEVICE="${DEVICE:-cuda}"
GPU="${GPU:-4}"
STEPS="${STEPS:-2000}"

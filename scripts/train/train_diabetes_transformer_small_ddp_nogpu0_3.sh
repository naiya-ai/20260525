...
RUN_NAME="${RUN_NAME:-transformer_small_d128_l4_lr3e5_beta001_diabetes_nogpu0_3_$(date +%Y%m%d_%H%M%S)}"
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/conditional_vae_transformer_small/${RUN_NAME}}"
CONFIG="${CONFIG:-configs/train/train_conditional_vae_transformer_small_diabetes.yaml}"
...
MIN_LEARNING_RATE="${MIN_LEARNING_RATE:-0.000003}"
BETA="${BETA:-0.001}"
...
LOG_PATH="${LOG_DIR}/${DISEASE}_transformer_small_ddp.log"
...
echo "==> Training diabetes transformer-small"
echo "==> run=${RUN_NAME}"

...
RUN_NAME="${RUN_NAME:-transformer_retry_ddp_${DISEASE}_$(date +%Y%m%d_%H%M%S)}"

CONFIG="${CONFIG:-configs/train/train_conditional_vae_transformer_separate_dmodel256_ff1024.yaml}"
VARIANT="${VARIANT:-transformer_separate_dmodel256_ff1024}"
...
echo "==> One-disease transformer retry DDP comparison"
